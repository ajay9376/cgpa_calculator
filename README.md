...
This tool is designed for students to track academic performance, plan goals, and visualize progress semester-wise.
...
5. Use Target Planner to calculate required SGPA for future semesters
